...
```{r}
ggplot(data = jails) +
  geom_bar(aes(x = private_jail_flag, fill = `Above Average Decrease in Prisoners`), position = "fill", color = "black") +
...
ggplot(data = privateyes, aes(x = "", fill = `Above Average Decrease in Prisoners`, y = n)) +
