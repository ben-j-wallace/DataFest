...
covidapproval <- read.csv("datafiles/Covidapproval.csv")
```
...
```{r}
governor_poll <- "https://www.msn.com/en-us/news/coronavirus/governors-average-27-percentage-points-higher-in-approval-for-covid-19-response-than-president-trump/ar-BB125j1Z?li=BBnb7Kz"

html <- read_html(governor_poll)
html_nodes(html, "igc-y-axis-text") %>%
   html_text()
