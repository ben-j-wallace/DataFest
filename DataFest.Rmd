...
ggplot() +
  geom_sf(aes(geometry = geom, fill = pct , color = pct), data = jails) +
...
```{r}
model2 <- lm(Percent_Change ~ County_Profile + State_Profile + Jurisdiction_Profile + COVID.19_Cases + pct, data = jails)
